...
import 'package:fullmark_task/widgets/image_widget.dart';
...
class _ExpandedCardState extends State<ExpandedCard> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: BoxDecoration(
          color: Colors.white, borderRadius: BorderRadius.circular(10.0), boxShadow: const [BoxShadow(color: Colors.black26, spreadRadius: 0.1, blurRadius: 10)]),
